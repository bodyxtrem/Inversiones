      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-10 md:grid-cols-3">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex gap-3"><Mail size={18} className="text-gold shrink-0" /> info@inventadogroup.com</li>
            <li className="flex gap-3"><Phone size={18} className="text-gold shrink-0" /> +34 900 000 000</li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10 py-6 text-center text-xs text-white/50">
        © {new Date().getFullYear()} Inventado Group. Todos los derechos reservados.
      </div>
    </footer>
  );
}
